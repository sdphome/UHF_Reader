...
extern LLRP_tSFrameExtract LLRP_FrameExtract(const unsigned char *pBuffer, unsigned int nBuffer);
...
extern LLRP_tSFrameDecoder *LLRP_FrameDecoder_construct(const LLRP_tSTypeRegistry * pTypeRegistry,
														unsigned char *pBuffer,
														unsigned int nBuffer);
...
extern LLRP_tSFrameEncoder *LLRP_FrameEncoder_construct(unsigned char *pBuffer,
														unsigned int nBuffer);
