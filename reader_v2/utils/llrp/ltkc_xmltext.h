...
extern LLRP_tSLibXMLTextDecoder *LLRP_LibXMLTextDecoder_construct(const LLRP_tSTypeRegistry *
																  pTypeRegistry,
...
extern LLRP_tSXMLTextEncoder *LLRP_XMLTextEncoder_construct(unsigned char *pBuffer,
															unsigned int nBuffer);

LLRP_tSLibXMLTextDecoder *LLRP_LibXMLTextDecoder_construct_file(const LLRP_tSTypeRegistry *
																pTypeRegistry, char *fname);

LLRP_tSLibXMLTextDecoder *LLRP_LibXMLTextDecoder_construct_nodetree(const LLRP_tSTypeRegistry *
																	pTypeRegistry,
