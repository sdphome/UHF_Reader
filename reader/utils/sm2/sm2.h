...
int sm3_e(u_char * userid, int userid_len, u_char * xa, int xa_len, u_char * ya, int ya_len,
		  u_char * msg, int msg_len, u_char * e);
...
void sm2_keygen(unsigned char *wx, int *wxlen, unsigned char *wy, int *wylen,
...
void sm2_sign(unsigned char *hash, int hashlen, unsigned char *privkey, int privkeylen,
			  unsigned char *cr, int *rlen, unsigned char *cs, int *slen);
...
int sm2_verify(unsigned char *hash, int hashlen, unsigned char *cr, int rlen, unsigned char *cs,
			   int slen, unsigned char *wx, int wxlen, unsigned char *wy, int wylen);
...
int sm2_encrypt(unsigned char *msg, int msglen, unsigned char *wx, int wxlen, unsigned char *wy,
				int wylen, unsigned char *outmsg);
...
int sm2_decrypt(unsigned char *msg, int msglen, unsigned char *privkey, int privkeylen,
...
int sm2_keyagreement_b1_9(unsigned char *kx1, int kx1len,
						  ...
						  unsigned char *yv, int *yvlen, unsigned char *sb);
...
int sm2_keyagreement_a4_10(unsigned char *kx1, int kx1len,
						   ...
						   unsigned int kalen,
						   unsigned char *kabuf, unsigned char *s1, unsigned char *sa);
...
void sm2_keyagreement_b10(unsigned char *pax, int paxlen,
						  unsigned char *pay, int paylen,
						  unsigned char *pbx, int pbxlen,
						  unsigned char *pby, int pbylen,
						  ...
						  unsigned char *ida, int idalen,
						  unsigned char *idb, int idblen, unsigned char *s2);
