...
extern void LLRP_bytesToEnd_set(llrp_bytesToEnd_t * pDst, llrp_bytesToEnd_t Value);
...
extern void LLRP_Error_clear(LLRP_tSErrorDetails * pError);

extern void
LLRP_Error_missingParameter(LLRP_tSErrorDetails * pError, const LLRP_tSTypeDescriptor * pRefType);

extern void
LLRP_Error_unexpectedParameter(LLRP_tSErrorDetails * pError, const LLRP_tSParameter * pParameter);

extern void
LLRP_Error_resultCodeAndWhatStr(LLRP_tSErrorDetails * pError,
								LLRP_tResultCode eResultCode, const char *pWhatStr);
...
struct LLRP_STypeDescriptor {
	...
	LLRP_tSElement *(*pfConstruct) (void);

	/* Destruct instance, dealloc memory */
	void
	 (*pfDestruct) (LLRP_tSElement * pElement);
	...
	void
	 (*pfDecodeFields) (LLRP_tSElement * pElement, LLRP_tSDecoderStream * pDecoderStream);
	 ...
	 */
	void
	 (*pfAssimilateSubParameters) (LLRP_tSElement * pElement, LLRP_tSErrorDetails * pError);

	/* Encode fields and subparameters */
	void
	 (*pfEncode) (const LLRP_tSElement * pElement, LLRP_tSEncoderStream * pEncoderStream);

	/* For extension parameters, ask if they are allowed in
	 * an enclosing parameter or message */
	 llrp_bool_t(*pfIsAllowedIn) (const LLRP_tSTypeDescriptor * pEnclosingElementType);
};
...
extern LLRP_tSTypeRegistry *LLRP_TypeRegistry_construct(void);

/* Destruct a TypeRegistry */
extern void LLRP_TypeRegistry_destruct(LLRP_tSTypeRegistry * pTypeRegistry);

/* Add a type descriptor to the registry */
extern LLRP_tResultCode
LLRP_TypeRegistry_enroll(LLRP_tSTypeRegistry * pTypeRegistry,
						 const LLRP_tSTypeDescriptor * pTypeDescriptor);

/* Lookup a standard message type descriptor. NULL=>not found */
const LLRP_tSTypeDescriptor *LLRP_TypeRegistry_lookupMessage(const LLRP_tSTypeRegistry *
															 pTypeRegistry,
															 unsigned int MessageTypeNum);

/* Lookup a standard parameter type descriptor. NULL=>not found */
const LLRP_tSTypeDescriptor *LLRP_TypeRegistry_lookupParameter(const LLRP_tSTypeRegistry *
															   pTypeRegistry,
															   unsigned int ParameterTypeNum);

/* Lookup a custom message type descriptor. NULL=>not found */
const LLRP_tSTypeDescriptor *LLRP_TypeRegistry_lookupCustomMessage(const LLRP_tSTypeRegistry *
																   pTypeRegistry,
																   unsigned int VendorID,
																   unsigned int MessageSubTypeNum);

/* Lookup a custom parameter type descriptor. NULL=>not found */
const LLRP_tSTypeDescriptor *LLRP_TypeRegistry_lookupCustomParameter(const LLRP_tSTypeRegistry *
																	 pTypeRegistry,
																	 unsigned int VendorID,
																	 unsigned int
																	 ParameterSubTypeNum);
...
const LLRP_tSTypeDescriptor *LLRP_TypeRegistry_lookupByName(const LLRP_tSTypeRegistry *
															pTypeRegistry,
...
extern void LLRP_Element_destruct(LLRP_tSElement * pElement);

extern void LLRP_Element_finalDestruct(LLRP_tSElement * pElement);

extern void
LLRP_Element_addSubParameterToAllList(LLRP_tSElement * pElement, LLRP_tSParameter * pParameter);

extern void
LLRP_Element_removeSubParameterFromAllList(LLRP_tSElement * pElement,
										   LLRP_tSParameter * pParameter);

extern void LLRP_Element_clearSubParameterAllList(LLRP_tSElement * pElement);

extern void
LLRP_Element_setSubParameterPtr(LLRP_tSElement * pElement,
								LLRP_tSParameter ** ppPtr, LLRP_tSParameter * pValue);

extern void
LLRP_Element_addToSubParameterList(LLRP_tSElement * pElement,
								   LLRP_tSParameter ** ppListHead, LLRP_tSParameter * pValue);

extern void
LLRP_Element_attachToSubParameterList(LLRP_tSParameter ** ppListHead, LLRP_tSParameter * pValue);

extern void
LLRP_Element_clearSubParameterList(LLRP_tSElement * pElement, LLRP_tSParameter ** ppListHead);

extern int
LLRP_Element_countSubParameterList(LLRP_tSElement * pElement, LLRP_tSParameter ** ppListHead);

extern int
LLRP_Element_walk(const LLRP_tSElement * pElement,
				  int (*pFunc) (const LLRP_tSElement * pElement,
								void *pArg), void *pArg, int iDepth, int nMaxDepth);

extern void LLRP_Message_setMessageID(LLRP_tSMessage * pMessage, llrp_u32_t MessageID);

extern llrp_bool_t
LLRP_Parameter_isAllowedIn(LLRP_tSParameter * pParameter,
						   const LLRP_tSTypeDescriptor * pEnclosingTypeDescriptor);

extern llrp_bool_t
LLRP_Parameter_isAllowedExtension(LLRP_tSParameter * pParameter,
								  const LLRP_tSTypeDescriptor * pEnclosingTypeDescriptor);
...
struct LLRP_SDecoderOps {
	void
	 (*pfDestruct) (LLRP_tSDecoder * pDecoder);
...
struct LLRP_SDecoderStreamOps {
	...
	llrp_u8_t
		(*pfGet_u8) (LLRP_tSDecoderStream * pDecoderStream,
					 const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_s8_t
		(*pfGet_s8) (LLRP_tSDecoderStream * pDecoderStream,
					 const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_u8v_t
		(*pfGet_u8v) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_s8v_t
		(*pfGet_s8v) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	llrp_u16_t
		(*pfGet_u16) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_s16_t
		(*pfGet_s16) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_u16v_t
		(*pfGet_u16v) (LLRP_tSDecoderStream * pDecoderStream,
					   const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_s16v_t
		(*pfGet_s16v) (LLRP_tSDecoderStream * pDecoderStream,
					   const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	llrp_u32_t
		(*pfGet_u32) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_s32_t
		(*pfGet_s32) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_u32v_t
		(*pfGet_u32v) (LLRP_tSDecoderStream * pDecoderStream,
					   const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_s32v_t
		(*pfGet_s32v) (LLRP_tSDecoderStream * pDecoderStream,
					   const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	llrp_u64_t
		(*pfGet_u64) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_s64_t
		(*pfGet_s64) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_u64v_t
		(*pfGet_u64v) (LLRP_tSDecoderStream * pDecoderStream,
					   const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_s64v_t
		(*pfGet_s64v) (LLRP_tSDecoderStream * pDecoderStream,
					   const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	llrp_u1_t
		(*pfGet_u1) (LLRP_tSDecoderStream * pDecoderStream,
					 const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_u1v_t
		(*pfGet_u1v) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_u2_t
		(*pfGet_u2) (LLRP_tSDecoderStream * pDecoderStream,
					 const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_u96_t
		(*pfGet_u96) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_utf8v_t
		(*pfGet_utf8v) (LLRP_tSDecoderStream * pDecoderStream,
						const LLRP_tSFieldDescriptor * pFieldDescriptor);

	llrp_bytesToEnd_t
		(*pfGet_bytesToEnd) (LLRP_tSDecoderStream * pDecoderStream,
							 const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	int
	 (*pfGet_e1) (LLRP_tSDecoderStream * pDecoderStream,
				  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	int
	 (*pfGet_e2) (LLRP_tSDecoderStream * pDecoderStream,
				  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	int
	 (*pfGet_e8) (LLRP_tSDecoderStream * pDecoderStream,
				  const LLRP_tSFieldDescriptor * pFieldDescriptor);

	int
	 (*pfGet_e16) (LLRP_tSDecoderStream * pDecoderStream,
				   const LLRP_tSFieldDescriptor * pFieldDescriptor);

	int
	 (*pfGet_e32) (LLRP_tSDecoderStream * pDecoderStream,
				   const LLRP_tSFieldDescriptor * pFieldDescriptor);

	 llrp_u8v_t
		(*pfGet_e8v) (LLRP_tSDecoderStream * pDecoderStream,
					  const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	void
	 (*pfGet_reserved) (LLRP_tSDecoderStream * pDecoderStream, unsigned int nBits);
};
...
struct LLRP_SEncoderOps {
	void
	 (*pfDestruct) (LLRP_tSEncoder * pEncoder);

	void
	 (*pfEncodeElement) (LLRP_tSEncoder * pEncoder, const LLRP_tSElement * pElement);
};
...
struct LLRP_SEncoderStreamOps {
	void
	 (*pfPutRequiredSubParameter) (LLRP_tSEncoderStream * pEncoderStream,
								   const LLRP_tSParameter * pParameter,
								   const LLRP_tSTypeDescriptor * pRefType);

	void
	 (*pfPutOptionalSubParameter) (LLRP_tSEncoderStream * pEncoderStream,
								   const LLRP_tSParameter * pParameter,
								   const LLRP_tSTypeDescriptor * pRefType);

	void
	 (*pfPutRequiredSubParameterList) (LLRP_tSEncoderStream * pEncoderStream,
									   const LLRP_tSParameter * pParameterList,
									   const LLRP_tSTypeDescriptor * pRefType);

	void
	 (*pfPutOptionalSubParameterList) (LLRP_tSEncoderStream * pEncoderStream,
									   const LLRP_tSParameter * pParameterList,
									   const LLRP_tSTypeDescriptor * pRefType);
	...
	void
	 (*pfPut_u8) (LLRP_tSEncoderStream * pEncoderStream,
				  const llrp_u8_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_s8) (LLRP_tSEncoderStream * pEncoderStream,
				  const llrp_s8_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_u8v) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_u8v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_s8v) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_s8v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	void
	 (*pfPut_u16) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_u16_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_s16) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_s16_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_u16v) (LLRP_tSEncoderStream * pEncoderStream,
					const llrp_u16v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_s16v) (LLRP_tSEncoderStream * pEncoderStream,
					const llrp_s16v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	void
	 (*pfPut_u32) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_u32_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_s32) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_s32_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_u32v) (LLRP_tSEncoderStream * pEncoderStream,
					const llrp_u32v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_s32v) (LLRP_tSEncoderStream * pEncoderStream,
					const llrp_s32v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	void
	 (*pfPut_u64) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_u64_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_s64) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_s64_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_u64v) (LLRP_tSEncoderStream * pEncoderStream,
					const llrp_u64v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_s64v) (LLRP_tSEncoderStream * pEncoderStream,
					const llrp_s64v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	void
	 (*pfPut_u1) (LLRP_tSEncoderStream * pEncoderStream,
				  const llrp_u1_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_u1v) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_u1v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_u2) (LLRP_tSEncoderStream * pEncoderStream,
				  const llrp_u2_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_u96) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_u96_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_utf8v) (LLRP_tSEncoderStream * pEncoderStream,
					 const llrp_utf8v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_bytesToEnd) (LLRP_tSEncoderStream * pEncoderStream,
	...
	void
	 (*pfPut_e1) (LLRP_tSEncoderStream * pEncoderStream,
				  const int Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_e2) (LLRP_tSEncoderStream * pEncoderStream,
				  const int Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_e8) (LLRP_tSEncoderStream * pEncoderStream,
				  const int Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_e16) (LLRP_tSEncoderStream * pEncoderStream,
				   const int Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_e32) (LLRP_tSEncoderStream * pEncoderStream,
				   const int Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);

	void
	 (*pfPut_e8v) (LLRP_tSEncoderStream * pEncoderStream,
				   const llrp_u8v_t Value, const LLRP_tSFieldDescriptor * pFieldDescriptor);
	...
	void
	 (*pfPut_reserved) (LLRP_tSEncoderStream * pEncoderStream, unsigned int nBits);
};

/*
 * ltkc_encdec.c
 */
extern void LLRP_Decoder_destruct(LLRP_tSDecoder * pDecoder);

LLRP_tSMessage *LLRP_Decoder_decodeMessage(LLRP_tSDecoder * pDecoder);

extern void LLRP_Encoder_destruct(LLRP_tSEncoder * pEncoder);

extern void LLRP_Encoder_encodeElement(LLRP_tSEncoder * pEncoder, const LLRP_tSElement * pElement);
...
extern LLRP_tResultCode
LLRP_toXMLString(const LLRP_tSElement * pElement, char *pBuffer, int nBuffer);
